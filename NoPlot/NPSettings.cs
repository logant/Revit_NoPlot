...
namespace NoPlot
{
    public class Settings
    {
        ...
        public void SaveSettings()
        {
            ...
            FileUtils.SetInt(assemblyName, nameof(Theme), Theme);
